...
<p align="center">
  <img alt="Bundle Size" src="https://badgen.net/bundlephobia/minzip/@hackr/chakra-ui-core"/>
  ...
  <img alt="NPM Downloads" src="https://img.shields.io/npm/dm/@hackr/chakra-ui-core.svg?style=flat"/>
...
`@hackr/chakra-ui-core` package and its peer dependencies:

```sh
$ yarn add @hackr/chakra-ui-core @emotion/core @emotion/styled emotion-theming

# or

$ npm install @hackr/chakra-ui-core @emotion/core @emotion/styled emotion-theming
```
...
1. Wrap your application with the `ThemeProvider` provided by
   **@hackr/chakra-ui-core**. We recommend that you also add the `CSSReset`
   component to remove all browser styling.

```jsx
import { ThemeProvider, CSSReset } from "@hackr/chakra-ui-core"
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="https://github.com/TimKolberger"><img src="https://avatars2.githubusercontent.com/u/16899513?v=4" width="64px;" alt=""/><br /><sub><b>TimKolberger</b></sub></a><br /><a href="https://github.com/chakra-ui/chakra-ui/issues?q=author%3ATimKolberger" title="Bug reports">🐛</a> <a href="https://github.com/chakra-ui/chakra-ui/commits?author=TimKolberger" title="Documentation">📖</a> <a href="https://github.com/chakra-ui/chakra-ui/commits?author=TimKolberger" title="Code">💻</a></td>
