...
- [`@hackr/gatsby-plugin-chakra-ui`](#gatsby-plugin)
...
After installation, you'll need to add `@hackr/gatsby-plugin-chakra-ui` to the
...
import { ChakraProvider, CSSReset } from "@hackr/chakra-ui-core"
