...
## Option 1: Using `forwardRef` from `@hackr/chakra-ui-core`
...
```tsx live=false
import { forwardRef, Box, BoxProps } from "@hackr/chakra-ui-core"
...
```tsx live=false
import { ChakraComponent, Box, BoxProps } from "@hackr/chakra-ui-core"
