...
```bash
npm i @hackr/chakra-ui-core framer-motion
# or
yarn add @hackr/chakra-ui-core framer-motion
```
...
> - For Gatsby, install the `@hackr/gatsby-plugin-chakra-ui`. It does it automatically
>   for you.
...
requirements, you can extend the `theme` from `@hackr/chakra-ui-core`.
...
| theme            | `Theme`          | `@hackr/chakra-ui-theme`    | optional custom theme                               |
...
- Icons: If you want to use the icons from Chakra UI, install `@hackr/chakra-ui-icons`
