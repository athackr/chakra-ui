...
import { useStyleConfig } from "@hackr/chakra-ui-core"
...
- `themeKey`: the key in `theme.components` that points to the desired
  styleConfig.
- `props`: an option of the options for computing the final styles. It
...
import { StylesProvider, useMultiStyleConfig, useStyles } from "@hackr/chakra-ui-core"
