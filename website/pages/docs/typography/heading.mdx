...
<ComponentLinks
  github={{ url: "#" }}
  storybook={{ url: "#" }}
  npm={{ label: "@hackr/chakra-ui-layout", url: "#" }}
/>
...
```js
import { Heading } from "@hackr/chakra-ui-core"
```
...
The `Heading` composes the [Box](/docs/layout/box) component, so you can pass all
`Box` props.
